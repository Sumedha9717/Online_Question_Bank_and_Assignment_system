...
<body>
    <div class="table">
                        ...
                        if($result)
                        {
                            while($row= mysqli_fetch_assoc($result))
                            {
                                ...
                                echo '<tr>
                                    ...
                                    <td>'.$userType.'</td>
                                    <td>
                                        <button><a href="updateMember.php?updateid='.$id.'"><i class="fa-solid fa-pen-to-square"></i></a></button>
        ...
        <div class="text-center mt-10">
                    <a href="user_data_download.php" class="btn btn-success" target="_blank">Data Export To Excel</a>
        </div>
    </div>
</body>
</html>